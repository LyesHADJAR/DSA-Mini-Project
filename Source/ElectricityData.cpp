...
vector<pair<Date, pair<double, double>>> Electricity_Data::get_data_in_range(const Date& start_date, const Date& end_date) const {
...
vector<pair<Date, double>> Electricity_Data::get_consumption_in_month(int year, int month) const {
    vector<pair<Date, double>> consumption_in_month;
...
vector<pair<Date, double>> Electricity_Data::get_production_in_month(int year, int month) const {
    vector<pair<Date, double>> production_in_month;
...
vector<pair<Date, double>> Electricity_Data::get_consumption_in_year(int year) const {
    vector<pair<Date, double>> consumption_in_year;
...
vector<pair<Date, double>> Electricity_Data::get_production_in_year(int year) const {
    vector<pair<Date, double>> production_in_year;
